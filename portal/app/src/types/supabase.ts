...
// Para regenerar: npx supabase gen types typescript --project-id ulghmzlxvebpdklaosxk > src/types/supabase.ts
// Proyecto: asc-facturacion · ID: ulghmzlxvebpdklaosxk · Generado: 2026-03-25
